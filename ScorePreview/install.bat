...
set "PLUGIN=bin\Release\ScorePreview.dll"
...
copy /y "%PLUGIN%" "%GAME_DIR%\BepInEx\plugins\ScorePreview.dll" >nul
if errorlevel 1 exit /b 1
echo [install] installed: %GAME_DIR%\BepInEx\plugins\ScorePreview.dll
echo [install] launch the game; prediction shows top-left in a round.
endlocal